...
class NotesService {
  ...
  async getNotes(owner) {
    try {
      ...
      /* 
      Data notes yang dihasilkan berpotensi duplikasi, 
      sehingga di akhir kueri, kita GROUP nilainya agar 
      menghilangkan duplikasi yang dilihat berdasarkan notes.id.
      */
