...
class StorageService {
  ...
  // di fungsi ini kita tidak akan melakukan proses penulisan berkas 
  // menggunakan teknik stream karena proses penulisan berkas dilakukan oleh service S3 langsung.
